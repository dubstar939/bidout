...
const Tooltip: React.FC<TooltipProps> = ({ content, children }) => {
  ...
  return (
    <span className="relative inline-block group">
      ...
      {isVisible && (
        <span className={`absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 rounded-lg shadow-2xl border text-[10px] font-bold leading-relaxed transition-all animate-in fade-in zoom-in-95 duration-200 ${
          isDark 
