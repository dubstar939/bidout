...
export const COLORS = {
  ...
  secondary: '#0d9488', // Dimmer Teal
  dark: '#0f172a',    // Deep Gun Metal
  surface: '#1e293b', // Lighter Gun Metal Surface
  accent: '#94a3b8',  // Slate accents
...
export const Icons = {
  ...
  Layout: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={props.className || "h-5 w-5"} fill="none" viewBox="0 0 24 24" stroke="currentColor">
